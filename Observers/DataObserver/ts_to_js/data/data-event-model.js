...
function updateOne(id, newValue) {
    return __awaiter(this, void 0, void 0, function () {
        var newData, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dataModel.create(newValue)];
                case 1:
                    newData = _a.sent();
                    data = new dataModel();
...
function removeById(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, dataModel.findByIdAndDelete(id).exec()];
        });
    });
}
