...
function publish() {
    return __awaiter(this, void 0, void 0, function () {
        var conn_result, channel, content, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(connection == undefined || connection == null)) return [3 /*break*/, 2];
                    return [4 /*yield*/, connectToBroker()];
                case 1:
                    conn_result = _a.sent();
                    if (conn_result != null) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, channel.sendToQueue("queue_name", Buffer.from(content))];
                case 4:
                    err_1 = _a.sent();
                    console.log("Failed to create broker channel, reason: " + err_1);
                    return [2 /*return*/, false];
